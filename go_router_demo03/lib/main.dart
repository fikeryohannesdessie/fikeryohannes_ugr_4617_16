          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => context.goNamed(
                'product',
                pathParameters: {'id': '23'},
                queryParameters: {'name': 'Router'},
              ),
              child: const Text('View Product (ID=23, Name=Router)'),
            ),
            ...
            ElevatedButton(
              onPressed: () => context.goNamed(
                'product',
                pathParameters: {'id': '17'},
                queryParameters: {'name': 'Car'},
              ),
              child: const Text('View Product (ID=17, Name=Car)'),
            ),
          ],
        ),
      ),
